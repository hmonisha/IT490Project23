...
// setting the routes
const newRouter=require('./src/routes/bookList') //path for the route 
app.use('/',newRouter) //routes for the home page
app.use('/details',newRouter) //route of details page
app.use('/addedBook',newRouter)
app.listen(port,()=>console.log(`running on ${port}`)) //specify the port

//for opening the port and going to diff pages